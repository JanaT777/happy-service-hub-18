...
import { RequestType, REQUEST_TYPE_LABELS } from '@/types/ticket';
...
export const TicketForm = ({ requestType, onBack, onSubmit }: Props) => {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      <button onClick={onBack} className="mb-6 flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
